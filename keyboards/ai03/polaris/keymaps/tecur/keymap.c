...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all( /* Base */
    ...
    KC_CAPS, DE_A,    DE_S,    DE_D,    DE_F,    DE_G,    DE_H,    DE_J,    DE_K,    DE_L,    DE_OE,   DE_AE,                     _______,
  ...
  [_FN] = LAYOUT_all( /* FN */
    ...
    KC_WHOM, KC_MYCM, KC_UP,   _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT,          _______,
    _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______,                   _______,
